...
import BannerTab from './Tabs/BannerTab.jsx';
...
const ContentManagement = () => {
  ...
  const [banners, setBanners] = useState([{ heading: "", subtext: "", buttonText: "", redirectUrl: "", imageFile: null, imagePreview: "" }]);
        ...
        return (
          <div className="space-y-5">
            ...
            <button
              type="button"
              onClick={() =>
                setBanners([...banners, { heading: "", subtext: "", buttonText: "", redirectUrl: "", imageFile: null, imagePreview: "" }])
              }
              className="px-4 py-2 bg-black text-white mt-4 hover:bg-gray-800 transition-colors rounded"
            >
              Add New Banner
            </button>
          </div>
