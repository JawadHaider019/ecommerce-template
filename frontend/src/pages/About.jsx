...
import { FaShieldAlt, FaRecycle, FaEye, FaQuoteLeft, FaSeedling } from 'react-icons/fa';
...
const About = () => {
  ...
  const HeroSection = useMemo(() => (
    <div className="relative">
      ...
      <img
        ...
        alt="Pure Clay - All-Natural Skincare & Personal Care Products"
        loading="eager"
        decoding="sync"
        width={1920}
        height={1080}
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-8">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-emerald-100">
              <FaQuoteLeft className="text-black/30 text-3xl mb-4" aria-hidden="true" />
          ...
          <div className="relative">
            <div className="relative rounded-2xl overflow-hidden shadow-2xl">
              <img
                ...
                alt="Pure Clay Natural Ingredients - Organic and sustainable products"
  ...
  // Memoized promise section
  const PromiseSection = useMemo(() => (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {loading ? (
              ...
              <div className="col-span-full text-center py-20 border-2 border-dashed border-gray-200 bg-white rounded-2xl">
                <div className="text-gray-300 text-6xl mb-6" aria-hidden="true">👥</div>
                ...
                <div key={member._id} className="bg-white rounded-2xl shadow-sm border border-gray-100 group hover:shadow-2xl transition-all duration-500 overflow-hidden hover:-translate-y-2">
                  <div className="relative overflow-hidden">
                    <img
                      ...
                      alt={`${member.name} - ${member.role} at Pure Clay`}
                      loading="lazy"
                      decoding="async"
                      width={400}
                      height={320}
